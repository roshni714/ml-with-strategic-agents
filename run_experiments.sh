...
for SEED in "${seeds[@]}";
do
    python train_beta.py main --n 1000000 --d 10 --perturbation_s 0.2 --perturbation_beta 0.025 --learning_rate 1. --max_iter $MAX_ITER --n_types 10 --save dim_10_test_generic --seed $SEED --gradient_type "total_deriv"
    python train_beta.py main --n 1000000 --d 10 --perturbation_s 0.2 --perturbation_beta 0.025 --learning_rate 1. --max_iter $MAX_ITER --n_types 10 --save dim_10_test_generic --seed $SEED --gradient_type "partial_deriv_loss_beta"
